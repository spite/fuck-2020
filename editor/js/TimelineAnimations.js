...
function TimelineAnimationBlock(editor, animation) {
  ...
  function update() {
    ...
    dom.style.left = animation.start * 100 * scale + "px";
    dom.style.top = animation.layer * 32 + "px";
    dom.style.width = (animation.end - animation.start) * 100 * scale + "px";
...
function TimelineAnimations(editor) {
  ...
  container.setBackground(
    "linear-gradient(#555 1px, transparent 1px) 0% 0% / 32px 32px repeat"
  );
